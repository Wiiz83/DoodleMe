...
var newUser = function(id, nom, prenom, pseudo, mdp){
	if (typeof listeUsers[id] != 'undefined') {
		listeUsers[id] = new utilisateur(id, desc, date, pseudo, mdp);
		return 1;
    }
    return 0;
}
...
var modificationUser = function(pseudo, mdp, nom, prenom, idUser){
	this.listeUsers[idUser] = new utilisateur(idUser, nom, prenom, pseudo, mdp);
}